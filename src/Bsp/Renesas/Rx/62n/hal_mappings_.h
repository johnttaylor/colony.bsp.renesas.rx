...
///
#define Cpl_Driver_Uart_Hal_clrTxIrq_MAP            Bsp_uartClrTxDataEmptyFlag
///
...
///
#define Cpl_Driver_Uart_Hal_isTxIrq_MAP             Bsp_uartIsTxDoneIrqEnabled
///
...
///
#define Cpl_Driver_Uart_Hal_clrRxIrq_MAP            Bsp_uartClrReceivedFlag
///
